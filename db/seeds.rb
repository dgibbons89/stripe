...
growth_hacking = Product.create(title: "Growth Hacking", price: "4.99", 
    subtitle: "Crash Course", sku: "GROHACK1" , author: "Mattan Griffel", 
    description: %{     <p>In this talk, Mattan Griffel introduces you to the concept of Growth Hacking and shares his favorite tips for getting started as a growth hacker.</p>
            ...
            author_description: %{<p>Hey, I'm Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
                ...
                length: "30 Minutes",
                author_image_name: "Mattan Griffel")

growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", price: "4.99", 
